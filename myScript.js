...
function confirmAnimal(){
  if (animalName.innerHTML === "") {
    ...
    document.getElementById("fodder").style.display= "block";
    ...
    animal.style.border ="0px";
    animal.style.boxShadow ="0px 0px 0px 0px black";
    animal.style.backgroundImage ="radial-gradient(rgb(235, 231, 88, 0), rgb(255, 147, 0, 0))";
    animalName.innerHTML;
    document.body.style.backgroundImage = "linear-gradient( rgb(0, 82, 191), rgb(135,206,250) 35%, rgb(255, 255, 255) 59%, rgb(50, 205, 50) 60%, rgb(0, 165, 0))";
    ...
    hunger = setInterval(function(){
      ...
      if (food <= 0) {clearInterval(hunger)}
    }, 10000);
    ...
    movement = setInterval(function(){
      ...
      document.getElementById("heart-animation").style.left = randomX + 900 + "px";
      document.getElementById("heart-animation").style.top = randomY + "px";
    }, 1800);
  }
}

document.getElementById("fodder").addEventListener("click", feed);
...
function feed(){
  ...
  feedInterval = setInterval(function(){
      food ++
      document.getElementById("fodder").removeEventListener("click", feed);
      document.getElementById("food").style.width= food + "px";
      document.getElementById("food").innerHTML="FOOD: " + food;
      if (food >= food_limit) {
...
document.getElementById("watering").addEventListener("click", watering);
...
function watering(){
  ...
  wateringInterval = setInterval(function(){
      document.getElementById("watering").removeEventListener("click", watering);
      water ++
      document.getElementById("water").style.width= water + "px";
      document.getElementById("water").innerHTML="WATER: " + water;
...
document.getElementById("playing").addEventListener("click", playing);

function playing(){
  var audio = new Audio('play.wav');
  audio.play();
  document.getElementById("playing").style.bottom= 170 + Math.floor(Math.random() * 550) + "px";
  document.getElementById("playing").style.right= 1200 - Math.floor(Math.random() * 1200) + "px";
  document.getElementById("playing").style.transform= "rotate(" + Math.floor(Math.random() * 1800) + "deg";
  var fun = parseInt(document.getElementById("fun").style.width, 10);
  var fun_limit = document.getElementById("fun-limit").innerHTML;
  if (fun <= fun_limit -5) {fun += Math.floor(Math.random() * 5)}
  document.getElementById("fun").style.width= fun + "px";
  document.getElementById("fun").innerHTML="FUN: " + fun;
...
death = setInterval(function(){
  ...
  if (health < 5) {
    ...
    document.getElementById("fodder").style.display= "none";
...
happiness = setInterval(function(){
  ...
  if (food > food_limit * 0.9 && water > water_limit * 0.9  && fun > fun_limit * 0.9 ) {
  ...
  else if ((food > food_limit * 0.75  || water > water_limit * 0.75  || fun > fun_limit * 0.75) && (food < food_limit * 0.9 || water < water_limit * 0.9 || fun < fun_limit * 0.9)) {
    document.getElementById("heart-animation").style.display= "none";
    animal.style.filter= "saturate(0.75) brightness(0.95)";
  }
  else if (food < food_limit * 0.65 || water < water_limit * 0.65 || fun < fun_limit * 0.65) {
    document.getElementById("heart-animation").style.display= "block";
